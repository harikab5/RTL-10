    ...
    <li>
      <Link to="/Takeaway-Pickup" className="hover:text-red-600">
        ...
        <div>
          ...
          <p className="text-gray-700 text-sm mb-4">Craving something delicious? Place your order online and enjoy fast delivery or easy pickup from Foodify!</p>
      ...
      <div className="border-t text-center text-gray-500 text-xs py-4">
